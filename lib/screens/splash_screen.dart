...
class _SplashScreenState extends State<SplashScreen>
  ...
  Future<void> _navigateAfterDelay() async {
    ...
    // Start overlay service (Display over other apps)
  ...
  Widget build(BuildContext context) {
    ...
    SystemChrome.setSystemUIOverlayStyle(
      const SystemUiOverlayStyle(
        ...
        systemNavigationBarColor: Color(0xFFf91a30), // Dark nav bar
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Container(
            decoration: const BoxDecoration(color: Color(0xFFf91a30)),
          ),
