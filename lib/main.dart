...
import 'package:webview_master_app/widgets/overlay_bubble.dart';
...
class _MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if (state == AppLifecycleState.resumed) {
      debugPrint('📱 App resumed: Stopping order notification sounds');
      NotificationService().cancelAllOrderNotifications();
      // Stop the persistent background service ringtone
