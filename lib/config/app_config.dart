...
class AppConfig {
  // ==================== APP IDENTITY ====================
  static const String appName = 'Abhikaro Delivery';
  ...
  static const String webUrl = 'https://foods.abhikaro.in/delivery';



  static const String notificationIcon = '@mipmap/ic_launcher'; // Default app launcher icon
  ...
  static const String apiBaseUrl = 'https://api.foods.abhikaro.in/api/';
